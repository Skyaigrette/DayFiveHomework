...
public class Main {
	...
	public static void main(String[] args) {
		...
		AuthService googleManager = new GoogleAuthManagerAdaptor(systemValidationService, emailSender,userManager); //validation, email userservice
		AuthService systemAuthManager = new SystemAuthManager(systemValidationService, emailSender, userManager);
